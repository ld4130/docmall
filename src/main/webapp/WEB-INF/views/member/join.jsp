      ...
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" id="joinForm" method="post" action="/member/join">
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control" name="mbsp_id" id="mbsp_id" placeholder="아이디는 8~12자 이내 입력">
            </div>
            <div class="col-md-3 mb-3">
            <label for="name">중복확인</label>
			<button type="button" id="btn_IdCheck" class="btn btn-primary">ID중복체크</button>
            </div>
            <div class="col-md-5 mb-3">
              <label for="name">이름</label>
              <input type="text" class="form-control" name="mbsp_name" id="mbsp_name" placeholder="이름 입력란" >
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="mbsp_password" id="mbsp_password" placeholder="비밀번호 입력해주세요.">
            </div>
            <div class="col-md-6 mb-3">
              <label for="nickname">비밀번호 확인</label>
              <input type="text" class="form-control" id="mbsp_repassword" placeholder="비밀번호 재확인">
             </div>
          </div>
          ...
          <div class="row">
	          <div class="col-md-4 mb-3">
	            ...
	            <input type="email" class="form-control" name="mbsp_email" id="mbsp_email" placeholder="이메일 입력란" required>
	            </div>
	          <div class="col-md-3 mb-3">
	            <label for="email">메일인증코드</label>
	            <button type="button" class="btn btn-primary" id="btn_authcode">인증코드요청</button> 
	            </div>
	          <div class="col-md-2 mb-3">
	            <label for="email">인증코드</label>
	            <input type="text" class="form-control" id="email_auth_code" placeholder="" required>
	            </div>
	            
	          <div class="col-md-3 mb-3">
	            <label for="email">메일인증확인</label>
	            <button type="button" class="btn btn-primary" id="btn_confirmAuthcode">인증 확인</button> 
	            </div>
          </div>
          ...
          <div class="row">
              ...
              <input type="text" class="form-control" name="mbsp_phone" id="mbsp_phone" placeholder="연락처 입력란">
          	</div>
          	
         	<div class="col-md-6 mb-3">
          	  <label for="nickname">닉네임</label>
              <input type="text" class="form-control" name="mbsp_nick" id="mbsp_nick" placeholder="닉네임 입력란">
           </div>
          </div>
