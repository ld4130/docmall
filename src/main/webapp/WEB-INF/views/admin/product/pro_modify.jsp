     		...
     		<div class="box box-primary">
     			...
     			<div class="box-body">	
					  <div class="form-group row">
					    ...
					    <div class="col-sm-3">
                <input type="hidden" name="pageNum" vaule="${cri.pageNum}">
                <input type="hidden" name="amount" vaule="${cri.amount}">
                <input type="hidden" name="type" vaule="${cri.type}">
                <input type="hidden" name="keyword" vaule="${cri.keyword}">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-4">
					      <select id="pro_buy" name="pro_buy">
					      	...
					      	<option value="N" ${productVO.pro_buy == 'Y' ? 'selected':''}>판매불가능</option>
					      </select>
					    </div>
					  </div>	  
...
<script>
  $(document).ready(function(){
    // ckeditor 환경설정. javascript object구문 사용
    let ckeditor_config = {
      ...
      filebrowserUploadUrl : '/admin/product/imageUpload' // url 입력시 업로드 탭 표시
    }
    ...
    $("#firstCategory").change(function(){
      ...
      $.getJSON(url, function(subCategoryData){
        ...
        secondCategory.append("<option value=''>2차 카테고리 선택</option>");   // 1차 카테고리 미 선택시 2차 카테고리 동작 X
